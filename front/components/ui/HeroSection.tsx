...
export function HeroSection({ title, description, primaryAction, secondaryAction, showLogo, backgroundImage = "/images/landing1.jpg" }: HeroSectionProps) {
  return (
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-7xl">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          >
            {showLogo ? (
              <div className="mb-4">
                <span className="text-5xl md:text-6xl lg:text-8xl font-black tracking-tighter text-white drop-shadow-2xl uppercase">
                  Dynamik Sport
                </span>
              </div>
            ) : (
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-white max-w-2xl mx-auto leading-relaxed drop-shadow-md font-medium"
            >
              {description}
            </motion.p>
          </motion.div>
